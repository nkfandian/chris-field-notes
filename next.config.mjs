const csp=[
 ...
 "connect-src 'self' https://*.supabase.co https://*.google-analytics.com https://*.vercel-insights.com https://*.googlesyndication.com https://*.doubleclick.net https://*.google.com",
