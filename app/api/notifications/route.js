...
export async function POST(){const session=await createSessionClient();if(!await getSiteAdmin(session))return Response.json({error:'unauthorized'},{status:401});return response()}
